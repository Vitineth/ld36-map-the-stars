...
public class L1R1 extends Room {
    ...
    public L1R1(Level parent) {
        super("Bedroom", "You blink open your eyes, the fire in the corner casting the room in an almost ethereal glow. Your head pounds as you turn around in the bed and begin to sit up. You squint slightly as the pain reaches a crescendo. You don't remember much of the night and your mind is hazy as to what you were doing. You know you must've been in this place, you haven't left for months. The room is small containing only a simple bed on which you lie, a small table next to you with a few shelves built in containing scattered papers and your diary, and a small fire in the corner that looks like its beginning to die down. You look to your diary and you wonder whether it could shed light on last nights activities.", "L1R1", parent);
    ...
    protected void setupDescriptions() {
        descriptions.put("FIRE", "The fire is hastily assembled with logs scattered haphazardly around the outside, no hope of catching fire. The wood in the centre is charred black with some regions slowly turning white and flaking off into ash. As far as you can see there is nothing unusual about the fire.");
    ...
    protected void setupCommands() {
        ...
        commands.put(CommandDefaults.PICK_UP + "(NOTE|PAPER)", () -> System.out.println("You can think of no use for this note and decide against picking it up."));
