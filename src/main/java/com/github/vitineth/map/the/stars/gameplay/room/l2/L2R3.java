...
//        tryImageLoad();
    ...
    public void enterRoom() {
        ...
        MapTheStars.getMtsMainWindow().getInteractivePanel().launchPuzzle(new AttackPuzzle("l2r1", getClass().getResourceAsStream("/combat/combat.snake.png"), 10,
                new String[]{"You grab the snake by its body, carefully avoiding its fangs, and throw it away from you. It slides on the ground slightly, dazed by the impact and returns its attention to you.", "Your dagger makes contact with the body of the snake annd cuts of a small piece of skin. The snake seems to ignore it and just becomes more intent on attacking you", "You crush the end of the snakes tail with the boot as it slithers near."},
                new String[]{"The snake sees your dagger flying towards it and slithers out of the way with surprising speed.", "The snake sliters rapidly under the table just as your boot is about to make contact", "The snake seems to almost jump slightly as the dagger comes near, avoiding its body by fractions of a centimetre"},
