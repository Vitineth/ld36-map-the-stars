...
public class L2R1 extends Room {
    ...
    protected void setupCommands() {
        ...
        commands.put("(BREAK BARS|PUSH( ON)? BARS|MOVE BARS|BEND BARS|USE BARS|INTERACT WITH BARS|HIT BARS)", new Callback() {
            @Override
            public void callback() {
                if (bound) {
        ...
        commands.put("(SLICE BONDS WITH BAR|FREE HANDS WITH BAR|USE BAR ON BONDS|USE BONDS ON BAR|CUT BONDS WITH BAR|USE BAR TO CUT BONDS|USE BAR TO FREE HANDS|USE BAR TO RELEASE HANDS)", new Callback() {
            @Override
            public void callback() {
                if (bound) {
